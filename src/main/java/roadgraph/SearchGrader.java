...
public class SearchGrader implements Runnable {
    ...
    public void runTest(int i, String file, String desc, GeographicPoint start, GeographicPoint end) {
        ...
        GraphLoader.loadRoadMap("src/main/resources/data/graders/mod2/" + file, graph);
        CorrectAnswer corr = new CorrectAnswer("src/main/resources/data/graders/mod2/" + file + ".answer", true);
