...
//           }
	...
	{
		GraphLoader.createIntersectionsFile("src/main/resources/data/maps/hollywood_small.map", "src/main/resources/data/intersections/hollywood_small.intersections");
		GraphLoader.createIntersectionsFile("src/main/resources/data/maps/new_york.map", "src/main/resources/data/intersections/new_york.intersections");
		GraphLoader.createIntersectionsFile("src/main/resources/data/maps/san_diego.map", "src/main/resources/data/intersections/san_diego.intersections");
		GraphLoader.createIntersectionsFile("src/main/resources/data/maps/ucsd.map", "src/main/resources/data/intersections/ucsd.intersections");
		...
		GraphLoader.createIntersectionsFile("src/main/resources/data/maps/Vancouver.map", 
					                         "src/main/resources/data/intersections/Vancouver.intersections");
