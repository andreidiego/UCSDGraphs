...
//		GraphLoader.createIntersectionsFile("src/main/resources/data/maps/myucsd.map", "src/main/resources/data/intersections/myucsd.intersections");
		...
		GraphLoader.loadRoadMap("src/main/resources/data/testdata/simpletest.map", graphFromFile);
		...
		GraphLoader.loadRoutes("src/main/resources/data/airports/routesUA.dat", airportGraph);
