...
public class GraphAdjMatrix extends Graph {
	...
	public List<Integer> getDistance2(int v) {
		...
		int[] vertexPossibleOutNeighbors = adjMatrix[v];

		for (int possibleOutNeighbor = 0; possibleOutNeighbor < vertexPossibleOutNeighbors.length; possibleOutNeighbor++) {
			boolean isOutNeighbor = vertexPossibleOutNeighbors[possibleOutNeighbor] > 0;

			if (isOutNeighbor) {
				int[] vertexPossibleTwoHopNeighbors = adjMatrix[possibleOutNeighbor];

				for (int possibleTwoHopNeighbor = 0; possibleTwoHopNeighbor < vertexPossibleTwoHopNeighbors.length; possibleTwoHopNeighbor++) {
					boolean isTwoHopNeighbor = vertexPossibleTwoHopNeighbors[possibleTwoHopNeighbor] > 0;

					if (isTwoHopNeighbor) {
						twoHopNeighbors.add(possibleTwoHopNeighbor);
					}
				}
			}
		}
